<div class="row row-cols-1 row-cols-lg-6 mb-3">
    <div class="feature col">
        <div class="bg-white p-2 border shadow-sm rounded-3 d-flex align-items-center position-relative">
            ...
            <a href="{{ route('user.index') }}" class="text-decoration-none text-dark fw-bold">Data User</a>
    ...
    <div class="feature col">
        <div class="bg-white p-2 border shadow-sm rounded-3 d-flex align-items-center position-relative">
            <img src="{{ asset('assets/icons/ic-gear.png') }}" height="20" alt="" class="me-2">
            <a href="{{ route('categories.index') }}" class="text-decoration-none text-dark fw-bold">Data Category</a>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning">
                0
                <span class="visually-hidden">unread messages</span>
            </span>
    ...
    <div class="feature col">
        <div class="bg-white p-2 border shadow-sm rounded-3 d-flex align-items-center position-relative">
            <img src="{{ asset('assets/icons/ic-gear.png') }}" height="20" alt="" class="me-2">
            <a href="" class="text-decoration-none text-dark fw-bold">Data Post</a>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning">
                0
                <span class="visually-hidden">unread messages</span>
            </span>
    ...
    <div class="feature col">
        <div class="bg-white p-2 border shadow-sm rounded-3 d-flex align-items-center position-relative">
            <img src="{{ asset('assets/icons/ic-gear.png') }}" height="20" alt="" class="me-2">
            <a href="{{ route('unit.index') }}" class="text-decoration-none text-dark fw-bold">Data Unit</a>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning">
                0
                <span class="visually-hidden">unread messages</span>
            </span>
    ...
    <div class="feature col">
        <div class="bg-white p-2 border shadow-sm rounded-3 d-flex align-items-center position-relative">
            <img src="{{ asset('assets/icons/ic-gear.png') }}" height="20" alt="" class="me-2">
            <a href="{{ route('video.index') }}" class="text-decoration-none text-dark fw-bold">Data Video</a>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning">
                0
                <span class="visually-hidden">unread messages</span>
            </span>
    ...
    <div class="feature col">
        <div class="bg-white p-2 border shadow-sm rounded-3 d-flex align-items-center position-relative">
            <img src="{{ asset('assets/icons/ic-gear.png') }}" height="20" alt="" class="me-2">
            <a href="" class="text-decoration-none text-dark fw-bold">Data Sliders</a>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning">
                0
                <span class="visually-hidden">unread messages</span>
            </span>
